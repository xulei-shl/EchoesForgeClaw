...
import {
  ...
  userMapPosterDir,
  userMapArtDir,
} from '../../../services/multimodal/image-service.js';
import {
...
} from '../../../services/ai/fastclaw-service.js';
import {
  textConfigFrom,
  visionConfigFrom,
  imageConfigFrom,
...
} from '../../../services/platform/node-config-service.js';
import {
...
} from '../../../services/ai/chat-conversations.js';
import {
  decodeDataUrlImage,
...
} from '../../../services/platform/file-utils.js';
import { withWidgetBridge, createWidgetStore } from '../../../services/ai/pi-widgets.js';
import {
  hydratePiSession,
  readSessionImageBlock,
  type HydratedFile,
  type HydratedStep,
} from '../../../services/ai/pi-session-hydrate.js';
import {
  nodeWorkspace,
  sanitizeWorkspaceId,
  workspacePath,
...
} from '../../../services/ai/fastclaw-artifacts.js';
