...
import { type FastClawEvent } from '../../services/ai/fastclaw-service.js';
...
import { type GlamProvider } from '../../services/multimodal/glam-search-service.js';
import { type DoubanClientConfig } from '../../services/node/douban-service.js';
...
export interface ChatRequest {
  ...
  /**
   * 思考开关（仅 Skill Agent 模式生效；'on'=启用思考、'off'=关闭，空/缺省 = 模型默认；
