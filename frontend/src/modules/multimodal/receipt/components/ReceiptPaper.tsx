 ...
 */
const LibraryCardPaper = React.forwardRef<HTMLDivElement, ReceiptPaperProps>(
  (
    {
      state,
      onChange,
 ...
 */
const StandardReceiptPaper = React.forwardRef<HTMLDivElement, ReceiptPaperProps>(
  (
    {
      state,
      onChange,
...
StandardReceiptPaper.displayName = 'StandardReceiptPaper';
...
export const ReceiptPaper = React.forwardRef<HTMLDivElement, ReceiptPaperProps>((props, ref) => {
  if (props.state.templateId === 'reading_log') {
    return <LibraryCardPaper ref={ref} {...props} />;
  }
  return <StandardReceiptPaper ref={ref} {...props} />;
});
