...
import { MAP_POSTER_DEFAULTS } from '../nodes/multimodal/engines/map/defaults';
import { JOURNAL_DEFAULTS } from '../nodes/multimodal/engines/journal/types';
import { TEXT_IMAGE_DEFAULTS } from '../nodes/multimodal/engines/textimage';
import { DEFAULT_BOOK_CARD_TEMPLATE_ID } from '../nodes/multimodal/engines/bookcard';

import type { NodeType, NodeData } from './graphTypes';
import type { NodeRunSettings } from '../../shared/types';
  ...
  switch (type) {
    ...
    case 'chat':
      return {
        ...
        settings: { includeUpstream: true, includeUpstreamImages: true },
        epoch: 0,
      };
    case 'text_aggregate':
      return {
