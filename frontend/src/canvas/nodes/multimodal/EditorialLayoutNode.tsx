...
} from './engines/editorial/types';
import {
  getEditorialTemplate,
  DEFAULT_EDITORIAL_TEMPLATE,
  getFreeLayoutSkeleton,
  DEFAULT_FREE_LAYOUT_SKELETON,
} from './engines/editorial/templates';
import {
  computeEditorialLayout,
  layoutFreeTextBlock,
} from './engines/editorial/engine/layoutEngine';
import { usePreloadJournalFonts, snapRotateCw, snapRotateCcw } from './engines/journal';

// 拆分出的 Hooks
import { useEditorialSync } from './engines/editorial/hooks/useEditorialSync';
import { useEditorialGestures } from './engines/editorial/hooks/useEditorialGestures';
import { useEditorialActions } from './engines/editorial/hooks/useEditorialActions';

// 拆分出的排版图层与抽屉组件
import { EditorialToolbar } from './engines/editorial/components/EditorialToolbar';
import { EditorialImageLayer } from './engines/editorial/components/EditorialImageLayer';
import { EditorialFreeTextLayer } from './engines/editorial/components/EditorialFreeTextLayer';
import { EditorialFreeTextToolbar } from './engines/editorial/components/EditorialFreeTextToolbar';
import { EditorialFixedLayoutLayer } from './engines/editorial/components/EditorialFixedLayoutLayer';
import { EditorialArticleDrawer } from './engines/editorial/components/EditorialArticleDrawer';
import { EditorialStyleDrawer } from './engines/editorial/components/EditorialStyleDrawer';
import { EditorialTextModal } from './engines/editorial/components/EditorialTextModal';
...
export interface EditorialLayoutNodeProps {
  ...
  upstreamBookData?: import('./engines/receipt/types').BookMetadataInput | null;
  isFavorited?: boolean;
  isPublic?: boolean;
  isSelected?: boolean;
