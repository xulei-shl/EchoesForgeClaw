...
export type CanvasNodeType =
  ...
  | 'pattern_search'
  /** 中国传统配色节点：742 款中国传统色检索/分类浏览/5色调色板生成器/场景灵感（多模态工具） */
  | 'color_search'
  /** 湿油彩效果节点：浏览器端 WebGL 流场笔触渲染，把输入图片重建为三层 Bézier 笔触 + 湿油彩质感的油画（多模态工具） */
  | 'oil_paint'
  /** 图片处理节点：浏览器端 Canvas 多效果图片处理（噪点 / ASCII / 网点 / 抖动），效果注册表驱动切换（多模态工具） */
  | 'image_process';
