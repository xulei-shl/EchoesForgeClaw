...
import type { MarqueeCandidate } from '../../canvas/core/Canvas';
import CanvasGroupFrame from '../../canvas/core/CanvasGroupFrame';
import {
  GROUP_COLORS,
  nextGroupColor,
  nextGroupName,
  computeGroupBounds,
} from '../../canvas/core/canvasGroups';
import { useGroupDrag } from '../../canvas/core/useGroupDrag';
import { IsbnInput } from '../../canvas/nodes/general/IsbnInput';
import { CanvasActionBar } from '../../canvas/nodes/_shared/CanvasActionBar';
import { AddNodeButton, type NodePickerItem } from '../../canvas/nodes/_shared/AddNodeButton';
...
} from '../../canvas/nodes/_shared/nodeTypes';
import {
  renderAggregateTemplate,
  syncAggregatePlaceholders,
} from '../../canvas/core/textTemplate';
import {
  type PortTypesLookup,
} from '../../canvas/core/execution';
import {
  DEFAULT_SIZES,
  bookInfoInflight,
  selfHealNode,
  ...
  type NodeSize,
  type NodeType,
} from '../../canvas/core/graphTypes';
import { useCanvasHistory } from '../../canvas/core/useCanvasHistory';
import { useGenerationHistory } from '../../library/history/useGenerationHistory';
import { useNodeExecution } from '../../canvas/core/useNodeExecution';
import { useManualConnection } from '../../canvas/core/useManualConnection';
import ConnectionGhost from '../../canvas/core/ConnectionGhost';
import { renderCanvasNode, type NodeViewHelpers } from '../../canvas/nodes/_shared/CanvasNodeViews';
import { seedDataFor } from '../../canvas/core/seedData';
...
import { ISBN_FETCH_TIMEOUT_MS } from '../../shared/utils/timeouts';
import type {
  CanvasNodeType,
  NodeRegistry,
  RegistryNodeConfig,
...
const CanvasPage: React.FC = () => {
  ...
  // 操作栏作用目标：优先选中且已有图片的 ImageNode / ReceiptNode / StampCutterNode / StickerMakerNode / OilPaintNode / ImageProcessNode / EmbossFoilNode / GlassRefractNode / EditorialLayoutNode / WatercolorBrushNode，否则回退到最近生成的图片节点
  const isImageResultNode = (n: any) =>
    (n.type === 'image_generation' || n.type === 'receipt_printer' || n.type === 'stamp_cutter' || n.type === 'image_bg_remove' || n.type === 'sticker_maker' || n.type === 'journal_maker' || n.type === 'text_image' || n.type === 'oil_paint' || n.type === 'image_process' || n.type === 'emboss_foil' || n.type === 'glass_refract' || n.type === 'editorial_layout' || n.type === 'watercolor_brush' || n.type === 'ink_wash') && Boolean(n.data?.imageUrl);
