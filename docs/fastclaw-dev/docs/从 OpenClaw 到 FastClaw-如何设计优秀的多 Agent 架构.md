...
![](https://cdn.shipany.ai/imgs/146af67fb90381e60075c6c421404074.png)
...
OpenClaw 引入了 [SOUL.md](http://soul.md/) 的概念——一个定义 Agent 人格、语气、价值观的配置文件。不是冷冰冰的 system prompt ，而是一份精心调教的"灵魂"。
...
配合 [SOUL.md](http://soul.md/) （人设）、 [USER.md](http://user.md/) （用户信息）等文件，Agent 可以记住你的偏好、习惯、常用工具，真正做到"越用越懂你"。
...
![](https://cdn.shipany.ai/imgs/b23bc8f85d32eb603d05c2e6c81118c1.png)
...
OpenClaw 每轮都会把一组 bootstrap 文件—— [SOUL.md](http://soul.md/) 、 [MEMORY.md](http://memory.md/) 、 [AGENTS.md](http://agents.md/) 、工具说明——注入提示词。文件一多、对话一长，system prompt 越堆越大。
...
![](https://cdn.shipany.ai/imgs/4dd53ad3ee7eb8cc9f3de86e348055c5.png)
...
![](https://cdn.shipany.ai/imgs/1bc1112ad836b6391ba0b68fff53a4ce.png)
...
![](https://cdn.shipany.ai/imgs/d34b12e01b3ba7c03189bbb14c16b178.png)
...
![](https://cdn.shipany.ai/imgs/9c744f3cf9b10523701e15834e50292b.png)

可接入常用的 IM 软件：

![](https://cdn.shipany.ai/imgs/7c5f04ecb8a0bc69f35d39e95520422a.png)

适合：个人用的 AI 助手、Telegram Bot 、Discord Bot 、飞书机器人、微信 ClawBot 。

### 2\. Factory：Agent 制造工厂

你可以在 [cloud.fastclaw.ai](https://cloud.fastclaw.ai/) 云平台创建自己的 Agent

![](https://cdn.shipany.ai/imgs/28c9ae4cfff9cf2783c2a7104ce69dee.png)

自定义 Agent 的 SOUL 、技能、模型。

![](https://cdn.shipany.ai/imgs/29de72d6ff3bc0d21efa122c89fd4753.png)
...
![](https://cdn.shipany.ai/imgs/f9b7ee3328d0b8a2d23f00e23d411bf2.png)

比如 [weclaw.im](https://weclaw.im/) 就是把 FastClaw 作为 Backend 的一个 Agent 应用，只做前端交互，一小时上线。

![](https://cdn.shipany.ai/imgs/5703bf8de099eb81ccd6370eaf3cb1eb.png)
...
![](https://cdn.shipany.ai/imgs/eab5318671ed94747de41a3885d42f92.png)
